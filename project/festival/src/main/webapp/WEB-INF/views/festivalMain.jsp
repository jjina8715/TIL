      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
       ...
       <!-- Right -->
		...
		<ul class="navbar-nav nav-flex-icons">
          <li class="nav-item">
            <a href="http://70.12.113.165:8000/festival/main" class="nav-link border border-light rounded">
				...
				<div id="wrapper">
					<div id="slider-wrap" >
						...
						<c:forEach var="vo" items="${img}">
							<li>
							 <img 
								src="http://70.12.113.165:8000/festival/resources/images/${vo}/1.jpg"
								onclick="location.href= 'http://70.12.113.165:8000/festival/detail?fid=${vo}';">
							</li>
						</c:forEach> 
						</ul>
				...
				<div id="wrapper">
					<div id="slider-wrap" >
						<ul id="slider2">
							...
							<li>
							<img 
								src="http://70.12.113.165:8000/festival/resources/images/${vo2}/1.jpg"
								onclick="location.href= 'http://70.12.113.165:8000/festival/detail?fid=${vo2}';">
							</li>
						</c:forEach> 
						</ul>
