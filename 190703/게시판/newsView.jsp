...
<body>
	...
	if(vo1!=null) {
		...
		<form method="post" action="/mvc/news">
			...
			<input id="writer" type="text" name="writer" value='<%=vo1.getWriter() %>' placeholder="작성자명을 입력해주세요." required><br>
			<input id="title" type="text" name="title" value='<%=vo1.getTitle() %>' placeholder="제목을 입력해주세요" required><br>
			<textarea id="context" name="content" placeholder="내용을 입력해주세요" required><%=vo1.getContent() %></textarea><br>
